...
prepare_source() {    
    ...
    wget -O gvm-libs.tar.gz https://github.com/greenbone/gvm-libs/archive/refs/tags/v22.7.1.tar.gz > /dev/null 2>&1;
    /usr/bin/logger '..ospd-openvas' -t 'gse-22.4.2';
    wget -O ospd-openvas.tar.gz https://github.com/greenbone/ospd-openvas/archive/refs/tags/v22.6.0.tar.gz > /dev/null 2>&1;
    /usr/bin/logger '..openvas-scanner' -t 'gse-22.4.0';
    wget -O openvas.tar.gz https://github.com/greenbone/openvas-scanner/archive/refs/tags/v22.7.5.tar.gz > /dev/null 2>&1;
    /usr/bin/logger '..gvm daemon' -t 'gse-22.4.0';
    wget -O gvmd.tar.gz https://github.com/greenbone/gvmd/archive/refs/tags/v22.9.0.tar.gz> /dev/null 2>&1;
    ...
    wget -O gsad.tar.gz https://github.com/greenbone/gsad/archive/refs/tags/v22.6.0.tar.gz > /dev/null 2>&1;
    /usr/bin/logger '..gsa webserver' -t 'gse-22.4.0';
    wget -O gsa.tar.gz https://github.com/greenbone/gsa/archive/refs/tags/v22.7.1.tar.gz > /dev/null 2>&1;
    ...
    wget -O gvm-tools.tar.gz https://github.com/greenbone/gvm-tools/archive/refs/tags/v23.9.0.tar.gz > /dev/null 2>&1;
    ...
    mv /opt/gvm/src/greenbone/gvm-libs-22.7.1 /opt/gvm/src/greenbone/gvm-libs > /dev/null 2>&1;
    mv /opt/gvm/src/greenbone/ospd-openvas-22.6.0 /opt/gvm/src/greenbone/ospd-openvas > /dev/null 2>&1;
    mv /opt/gvm/src/greenbone/openvas-scanner-22.7.5 /opt/gvm/src/greenbone/openvas > /dev/null 2>&1;
    mv /opt/gvm/src/greenbone/gvmd-22.9.0 /opt/gvm/src/greenbone/gvmd > /dev/null 2>&1;
    mv /opt/gvm/src/greenbone/gsa-22.7.1 /opt/gvm/src/greenbone/gsa > /dev/null 2>&1;
    mv /opt/gvm/src/greenbone/gsad-22.6.0 /opt/gvm/src/greenbone/gsad > /dev/null 2>&1;
    ...
    mv /opt/gvm/src/greenbone/gvm-tools-23.9.0 /opt/gvm/src/greenbone/gvm-tools > /dev/null 2>&1;
