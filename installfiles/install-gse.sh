...
prepare_source() {    
    ...
    /usr/bin/logger '..gsa webserver' -t 'gce-23.1.0';
...
update_feed_data() {
    ...
    /opt/gvm/gvmpy/bin/greenbone-feed-sync --type all --user gvm --group gvm --gvmd-lock-file /run/gvmd/feed-update.lock --openvas-lock-file /run/gvmd/feed-update.lock;
...
configure_feed_owner() {
    ...
    then
        ...
        /usr/bin/logger 'configure_feed_owner User creation success' -t 'gce-23.1.0';
    else
...
start_services() {
    ...
    then
        ...
        /usr/bin/logger 'gvmd.service started successfully' -t 'gce-23.1.0';
    else
        echo -e "\e[1;31mgvmd.service FAILED!\e[0m";
        /usr/bin/logger 'gvmd.service FAILED' -t 'gce-23.1.0';
    fi
    # gsad.service
    if systemctl is-active --quiet gsad.service;
    then
        echo -e "\e[1;32mgsad.service started successfully";
        /usr/bin/logger 'gsad.service started successfully' -t 'gce-23.1.0';
    else
        echo -e "\e[1;31mgsad.service FAILED!\e[0m";
        /usr/bin/logger "gsad.service FAILED!" -t 'gce-23.1.0';
    fi
    ...
    then
        ...
        /usr/bin/logger 'ospd-openvas.service started successfully' -t 'gce-23.1.0';
    else
        echo -e "\e[1;31mospd-openvas.service FAILED!";
        /usr/bin/logger 'ospd-openvas.service FAILED!\e[0m' -t 'gce-23.1.0';
    fi
