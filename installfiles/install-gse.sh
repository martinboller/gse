...
install_prerequisites() {
    /usr/bin/logger 'install_prerequisites' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger "Operating System $OS Version $VER Codename $CODENAME" -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..install some basic tools not available if installed from Debian net install' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..Tools for Development' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..Prerequisites for Greenbone Security Assistant' -t 'gce-2024-04-09';
    ...
    if [ $VER -eq "11" ] 
        then
            /usr/bin/logger '..install_prerequisites_debian_11_bullseye' -t 'gce-2024-04-09';
            ...
            /usr/bin/logger '....Other prerequisites for Greenbone Community Edition on Debian 11' -t 'gce-2024-04-09';
        ...
        then
            /usr/bin/logger '..install prerequisites Debian 12 Bookworm' -t 'gce-2024-04-09';
            ...
            /usr/bin/logger '..install_prerequisites_debian_Untested' -t 'gce-2024-04-09';
            ...
            echo -e "\e[1;36m...installing prerequisites for Greenbone Community Edition\e[0m";
            /usr/bin/logger '....Other prerequisites for Greenbone Community Edition on unknown OS' -t 'gce-2024-04-09';
            apt-get -qq -y install software-properties-common libgpgme11-dev uuid-dev libhiredis-dev libgnutls28-dev libgpgme-dev \
                bison libksba-dev libsnmp-dev libgcrypt20-dev gnutls-bin nmap xmltoman gcc-mingw-w64 graphviz nodejs rpm nsis \
                sshpass socat gettext python3-polib libldap2-dev libradcli-dev libpq-dev perl-base heimdal-dev libpopt-dev \
                python3-psutil fakeroot gnupg socat snmp smbclient rsync python3-paramiko python3-lxml \
    ...
    /usr/bin/logger '..install prerequisites finished' -t 'gce-2024-04-09';
    ...
    # Required for PDF report generation
       /usr/bin/logger '....Prerequisites for PDF report generation' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '....Install some preferences on Debian and clean up apt' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_prerequisites finished' -t 'gce-2024-04-09';
}

clean_env() {
    /usr/bin/logger 'clean_env()' -t 'gce-2024-04-09';
    echo -e "\e[1;32mclean_env()\e[0m";
    ## Deleting file with variables environment variables from env
    rm $ENV_DIR/.env > /dev/null 2>&1;
    /usr/bin/logger 'clean_env() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mclean_env() finished\e[0m";
}

prepare_nix() {
    /usr/bin/logger 'prepare_nix()' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'prepare_nix() finished' -t 'gce-2024-04-09';
}

prepare_source() {    
    /usr/bin/logger 'prepare_source' -t 'gce-2024-04-09';
   ...
   /usr/bin/logger '..greenbone-feed-sync' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..open and extract the tarballs' -t 'gce-2024-04-09';
    find *.gz | xargs -n1 tar zxvfp > /dev/null 2>&1;
    sync;

    # Naming of directories w/o version
    /usr/bin/logger '..rename directories' -t 'gce-2024-04-09';    
    ...
    /usr/bin/logger 'prepare_source finished' -t 'gce-2024-04-09';
}

install_libxml2() {
    /usr/bin/logger 'install_libxml2' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_libxml2()\e[0m";
    cd /opt/gvm/src;
    /usr/bin/logger '..git clone libxml2' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...git clone libxml2()\e[0m";
    git clone https://gitlab.gnome.org/GNOME/libxml2
    cd libxml2;
    /usr/bin/logger '..autogen libxml2' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...autogen libxml2()\e[0m";
    ./autogen.sh
    # /usr/bin/logger '..make libxml2' -t 'gce-2024-04-09';
    # echo -e "\e[1;36m...make libxml2()\e[0m";
    # make;
    /usr/bin/logger '..make install libxml2' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...make install libxml2()\e[0m";
    make install;
    /usr/bin/logger '..ldconfig libxml2' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...ldconfig libxml2()\e[0m";
    ldconfig;
}

install_poetry() {
    /usr/bin/logger 'install_poetry' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_poetry finished' -t 'gce-2024-04-09';
}

install_pggvm() {
    /usr/bin/logger 'install_pggvm' -t 'gce-2024-04-09';
    ...
    #/usr/bin/logger '..make pg-gvm PostgreSQL server extension' -t 'gce-2024-04-09';
    #echo -e "\e[1;36m...make pg-gvm PostgreSQL server extension\e[0m";
    #make > /dev/null 2>&1;
    #/usr/bin/logger '..make pg-gvm libraries Documentation' -t 'gce-2024-04-09';
    #make doc-full;
    /usr/bin/logger '..make install pg-gvm PostgreSQL server extension' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...make install pg-gvm PostgreSQL server extension\e[0m";
    make install > /dev/null 2>&1;
    sync;
    echo -e "\e[1;32minstall_pggvm() finished\e[0m";
    /usr/bin/logger 'install_pggvm finished' -t 'gce-2024-04-09';
}

install_notus() {
    /usr/bin/logger 'install_notus' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_notus finished' -t 'gce-2024-04-09';
}

install_gvm_libs() {
    /usr/bin/logger 'install_gvmlibs' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_gvmlibs()\e[0m";
    cd /opt/gvm/src/greenbone/ > /dev/null 2>&1;
    cd gvm-libs/ > /dev/null 2>&1;
    chown -R gvm:gvm /opt/gvm/ > /dev/null 2>&1;
    export PKG_CONFIG_PATH=/opt/gvm/lib/pkgconfig:$PKG_CONFIG_PATH;
    /usr/bin/logger '..cmake Greenbone Vulnerability Manager libraries (gvm-libs)' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...cmake Greenbone Vulnerability Manager libraries (gvm-libs)\e[0m";
    cmake -DCMAKE_INSTALL_PREFIX=/opt/gvm . > /dev/null 2>&1;
    # /usr/bin/logger '..make Greenbone Vulnerability Manager libraries (gvm-libs)' -t 'gce-2024-04-09';
    # echo -e "\e[1;36m...make Greenbone Vulnerability Manager libraries (gvm-libs)\e[0m";
    # make > /dev/null 2>&1;
    #/usr/bin/logger '..make gvm libraries Documentation' -t 'gce-2024-04-09';
    #make doc-full;
    /usr/bin/logger '..make install Greenbone Vulnerability Manager libraries (gvm-libs)' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_gvmlibs finished' -t 'gce-2024-04-09';
}

install_python_gvm() {
    /usr/bin/logger 'install_python_gvm' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_python_gvm finished' -t 'gce-2024-04-09';
}

install_python_ical() {
    /usr/bin/logger 'install_python_ical()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_python_ical finished' -t 'gce-2024-04-09';
}

install_openvas_smb() {
    /usr/bin/logger 'install_openvas_smb' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..cmake OpenVAS SMB' -t 'gce-2024-04-09';
    export PKG_CONFIG_PATH=/opt/gvm/lib/pkgconfig:$PKG_CONFIG_PATH;
    cmake -DCMAKE_INSTALL_PREFIX=/opt/gvm . > /dev/null 2>&1;
    # /usr/bin/logger '..make OpenVAS SMB' -t 'gce-2024-04-09';
    # echo -e "\e[1;36m...make OpenVAS SMB\e[0m";
    # make > /dev/null 2>&1;                
    #/usr/bin/logger '..make Openvas SMB Documentation' -t 'gce-2024-04-09';
    #make doc-full;
    /usr/bin/logger '..make install OpenVAS SMB' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_openvas_smb finished' -t 'gce-2024-04-09';
}

install_ospd_openvas() {
    /usr/bin/logger 'install_ospd_openvas' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_ospd_openvas finished' -t 'gce-2024-04-09';
}

install_openvas() {
    /usr/bin/logger 'install_openvas()' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_openvas()\e[0m";
    cd /opt/gvm/src/greenbone > /dev/null 2>&1;
    # Configure and build scanner
    cd openvas > /dev/null 2>&1;
    chown -R gvm:gvm /opt/gvm > /dev/null 2>&1;
    /usr/bin/logger '..cmake OpenVAS Scanner' -t 'gce-2024-04-09';
    export PKG_CONFIG_PATH=/opt/gvm/lib/pkgconfig:$PKG_CONFIG_PATH;
    echo -e "\e[1;36m...cmake OpenVAS Scanner\e[0m";
    cmake -DCMAKE_INSTALL_PREFIX=/opt/gvm . > /dev/null 2>&1;
    #/usr/bin/logger '..make OpenVAS Scanner' -t 'gce-2024-04-09';
    #/usr/bin/logger '..make Openvas Scanner Documentation' -t 'gce-2024-04-09';
    #make doc-full;
    ...
    /usr/bin/logger '..make install OpenVAS Scanner' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...make install openvas scanner\e[0m";
    make install > /dev/null 2>&1;
    /usr/bin/logger '..Rebuild make cache, OpenVAS Scanner' -t 'gce-2024-04-09';
    make rebuild_cache > /dev/null 2>&1;
    sync;
    echo -e "\e[1;36m...load OpenVAS Scanner libraries\e[0m";
    ldconfig > /dev/null 2>&1;
    echo -e "\e[1;32minstall_openvas() finished\e[0m";
    /usr/bin/logger 'install_openvas finished' -t 'gce-2024-04-09';
}

install_gvm() {
    /usr/bin/logger 'install_gvm()' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_gvm()\e[0m";
    cd /opt/gvm/src/greenbone;
    # Build Manager
    cd gvmd/ > /dev/null 2>&1;
    /usr/bin/logger '..cmake GVM Daemon' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...cmake Greenbone Vulnerability Manager (GVM)\e[0m";
    export PKG_CONFIG_PATH=/opt/gvm/lib/pkgconfig:$PKG_CONFIG_PATH;
    cmake -DCMAKE_INSTALL_PREFIX=/opt/gvm . > /dev/null 2>&1;
    # /usr/bin/logger '..make GVM Daemon' -t 'gce-2024-04-09';
    # echo -e "\e[1;36m...make Greenbone Vulnerability Manager (GVM)\e[0m";
    # make > /dev/null 2>&1;
    #/usr/bin/logger '..make documentation for GVM Daemon' -t 'gce-2024-04-09';
    #make doc-full;
    /usr/bin/logger '..make install GVM Daemon' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...make install Greenbone Vulnerability Manager (GVM)\e[0m";
    make install > /dev/null 2>&1;
    sync;
    echo -e "\e[1;32minstall_gvm() finished\e[0m";
    /usr/bin/logger 'install_gvm() finished' -t 'gce-2024-04-09';
}

install_nmap() {
    /usr/bin/logger 'install_nmap' -t 'gce-2024-04-09';
    cd /opt/gvm/src/greenbone;
    # Install NMAP
    apt-get -qq -y install nmap --fix-missing > /dev/null 2>&1;
    sync;
    /usr/bin/logger 'install_nmap finished' -t 'gce-2024-04-09';
}

install_greenbone_feed_sync() {
    /usr/bin/logger 'install_greenbone_feed_sync()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_greenbone_feed_sync() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_greenbone_feed_sync() finished\e[0m";
}

prestage_scan_data() {
    /usr/bin/logger 'prestage_scan_data' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..opening and extracting TAR Ball' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...opening and extracting TAR ball with prestaged feed data\e[0m";
    tar -xzf scandata.tar.gz > /dev/null 2>&1; 
    /usr/bin/logger '..copy feed data to /gvm/lib/gvm and openvas' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'prestage_scan_data finished' -t 'gce-2024-04-09';
}

update_feed_data() {
    /usr/bin/logger 'update_feed_data' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'update_feed_data finished' -t 'gce-2024-04-09';
}

install_gsad() {
    /usr/bin/logger 'install_gsad' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..cmake Greenbone Security Assistant Daemon (GSAD)' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...cmake Greenbone Security Assistant Daemon (GSAD)\e[0m";
    export PKG_CONFIG_PATH=/opt/gvm/lib/pkgconfig:$PKG_CONFIG_PATH;
    cmake -DCMAKE_INSTALL_PREFIX=/opt/gvm . > /dev/null 2>&1;
    # /usr/bin/logger '..make GSA Daemon' -t 'gce-2024-04-09';
    # echo -e "\e[1;36m...make Greenbone Security Assistant Daemon (GSAD)\e[0m";
    # make > /dev/null 2>&1; # build the libraries
    #/usr/bin/logger '..make documentation for GSA Daemon' -t 'gce-2024-04-09';
    #make doc-full;       # build more developer-oriented documentation
    /usr/bin/logger '..make install GSA Daemon' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_gsad finished' -t 'gce-2024-04-09';
}

install_gsa_web() {
    /usr/bin/logger 'install_gsa_web()' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_gsa_web() \e[0m";
    ## Install GSA
    cd /opt/gvm/src/greenbone > /dev/null 2>&1;
    chown -R gvm:gvm /opt/gvm > /dev/null 2>&1;
    # GSA prerequisites
    /usr/bin/logger '..installing Yarn' -t 'gce-2024-04-09';
    echo -e "\e[1;36m...installing yarn\e[0m";
    apt-get -qq -y install yarnpkg > /dev/null 2>&1;
    # GSA Install
    cd gsa/ > /dev/null 2>&1;
    /usr/bin/logger '..Build GSA Web Server' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_gsa_web() finished' -t 'gce-2024-04-09';
}

browserlist_update(){
    /usr/bin/logger 'browserlist_update()' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'browserlist_update() finished' -t 'gce-2024-04-09';
}

install_gvm_tools() {
    /usr/bin/logger 'install_gvm_tools' -t 'gce-2024-04-09';
...
#    /usr/poetry/bin/poetry install > /dev/null 2>&1;
    ...
    /usr/bin/logger 'install_gvm_tools finished' -t 'gce-2024-04-09';
}

install_impacket() {
    /usr/bin/logger 'install_impacket' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_impacket finished' -t 'gce-2024-04-09';
}

prepare_gvmpy() {
    /usr/bin/logger 'prepare_gvmpy' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'prepare_gvmpy finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mprepare_gvmpy() finished\e[0m";
}

prepare_postgresql() {
    /usr/bin/logger 'prepare_postgresql' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'prepare_postgresql finished' -t 'gce-2024-04-09';
}

tune_postgresql() {
    /usr/bin/logger 'tune_postgresql()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'tune_postgresql() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mtune_postgresql() finished\e[0m";
}

configure_openvas() {
    /usr/bin/logger 'configure_openvas' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_openvas finished' -t 'gce-2024-04-09';
}

configure_gvm() {
    /usr/bin/logger 'configure_gvm' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_gvm() finished' -t 'gce-2024-04-09';
}

configure_gsa() {
    /usr/bin/logger 'configure_gsa' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_gsa finished' -t 'gce-2024-04-09';
}

create_wrapper() {
    echo -e "\e[1;32mcreate_wrapper()\e[0m";
    /usr/bin/logger 'create_wrapper' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'create_wrapper finished' -t 'gce-2024-04-09';
}

configure_feed_owner() {
    /usr/bin/logger 'configure_feed_owner' -t 'gce-2024-04-09';
    ...
    then
        ...
        /usr/bin/logger 'configure_feed_owner User creation success' -t 'gce-2024-04-09';
    else
        echo "User admin for GVM $HOSTNAME could NOT be created - FAIL!" >> /var/lib/gvm/adminuser;
        /usr/bin/logger 'configure_feed_owner User creation FAILED!' -t 'gce-2024-04-09';
    fi
    echo -e "\e[1;32mconfigure_feed_owner() finished\e[0m";
    /usr/bin/logger 'configure_feed_owner finished' -t 'gce-2024-04-09';
}

configure_greenbone_updates() {
    /usr/bin/logger 'configure_greenbone_updates' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_greenbone_updates finished' -t 'gce-2024-04-09';
}   

start_services() {
    /usr/bin/logger 'start_services' -t 'gce-2024-04-09';
    ...
    then
        ...
        /usr/bin/logger 'gvmd.service started successfully' -t 'gce-2024-04-09';
    else
        echo -e "\e[1;31mgvmd.service FAILED!\e[0m";
        /usr/bin/logger 'gvmd.service FAILED' -t 'gce-2024-04-09';
    fi
    # gsad.service
    if systemctl is-active --quiet gsad.service;
    then
        echo -e "\e[1;32mgsad.service started successfully";
        /usr/bin/logger 'gsad.service started successfully' -t 'gce-2024-04-09';
    else
        echo -e "\e[1;31mgsad.service FAILED!\e[0m";
        /usr/bin/logger "gsad.service FAILED!" -t 'gce-2024-04-09';
    fi
    ...
    then
        ...
        /usr/bin/logger 'ospd-openvas.service started successfully' -t 'gce-2024-04-09';
    else
        echo -e "\e[1;31mospd-openvas.service FAILED!";
        /usr/bin/logger 'ospd-openvas.service FAILED!\e[0m' -t 'gce-2024-04-09';
    fi
    ...
    then
        ...
        /usr/bin/logger 'notus-scanner.service started successfully' -t 'gce-2024-04-09';
    else
        echo -e "\e[1;31mnotus-scanner.service FAILED!";
        /usr/bin/logger 'notus-scanner.service FAILED!\e[0m' -t 'gce-2024-04-09';
    fi
    if systemctl is-active --quiet gse-update.timer;
    then
        echo -e "\e[1;32mgse-update.timer started successfully\e[0m"
        /usr/bin/logger 'gse-update.timer started successfully' -t 'gce-2024-04-09';
    else
        echo -e "\e[1;31mgse-update.timer FAILED! Updates will not be automated\e[0m";
        /usr/bin/logger 'gse-update.timer FAILED! Updates will not be automated' -t 'gce-2024-04-09';
    fi
    echo -e "\e[1;32mstart_services() finished\e[0m";
    /usr/bin/logger 'start_services finished' -t 'gce-2024-04-09';
}

configure_redis() {
    /usr/bin/logger 'configure_redis' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_redis finished' -t 'gce-2024-04-09';
}

prepare_db_maintenance() {
    echo -e "\e[1;32mprepare_db_maintenance()\e[0m";
    /usr/bin/logger 'prepare_db_maintenance()' -t 'gce-2024-04-09';
    ## Weekly maintenance
...
__EOF__
    ...
    /usr/bin/logger 'prepare_db_maintenance() finished' -t 'gce-2024-04-09';
}

prepare_gpg() {
    /usr/bin/logger 'prepare_gpg' -t 'gce-2024-04-09';
    echo -e "\e[1;32mprepare_gpg()\e[0m";
    echo -e "\e[1;36m...Downloading and importing Greenbone Community Signing Key (PGP)\e[0m";
    /usr/bin/logger '..Downloading and importing Greenbone Community Signing Key (PGP)' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger '..Fully trust Greenbone Community Signing Key (PGP)' -t 'gce-2024-04-09';
    ...
    gpg -q --import-ownertrust < /tmp/ownertrust.txt;
    /usr/bin/logger 'prepare_gpg finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mprepare_gpg() finished\e[0m";
}

configure_feed_validation() {
    /usr/bin/logger 'configure_feed_validation()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'configure_feed_validation() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mconfigure_feed_validation() finished\e[0m";
}

configure_permissions() {
    /usr/bin/logger 'configure_permissions' -t 'gce-2024-04-09';
    echo -e "\e[1;32mconfigure_permissions()\e[0m";
    /usr/bin/logger '..Setting correct ownership of files for user gvm' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'configure_permissions finished' -t 'gce-2024-04-09';
}

get_scanner_status() {
    /usr/bin/logger 'get_scanner_status()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger ''Default OpenVAS $(su gvm -c "/opt/gvm/sbin/gvmd --verify-scanner 08b69003-5fc2-4037-a479-93b440211c73")'' -t 'gce-2024-04-09';    
    /usr/bin/logger ''Default CVE $(su gvm -c "/opt/gvm/sbin/gvmd --verify-scanner 6acd0832-df90-11e4-b9d5-28d24461215b")'' -t 'gce-2024-04-09';
    echo -e "\e[1;32mget_scanner_status() finished\e[0m";
}

create_gvm_python_script() {
    /usr/bin/logger 'create_gvm_python_script' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'create_gvm_python_script finished' -t 'gce-2024-04-09';
}

configure_cmake() {
    /usr/bin/logger 'configure_cmake' -t 'gce-2024-04-09';
   ...
   /usr/bin/logger 'configure_cmake finished' -t 'gce-2024-04-09';
}
...
install_nginx() {
    /usr/bin/logger 'install_nginx()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_nginx() finished' -t 'gce-2024-04-09';
}

configure_nginx() {
    /usr/bin/logger 'configure_nginx()' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'configure_nginx() finished' -t 'gce-2024-04-09';
}
...
nginx_certificates() {
    ...
    /usr/bin/logger 'nginx_certificates()' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'nginx_certificates() finished' -t 'gce-2024-04-09';
...
install_exim() {
    ...
    /usr/bin/logger 'install_exim()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'install_exim() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32minstall_exim() finished\e[0m";    
}

configure_exim() {
    ## Configures Exim4 from the env variables specified
    /usr/bin/logger 'configure_exim()' -t 'gce-2024-04-09';
...
toggle_vagrant_nic() {
    ...
    /usr/bin/logger 'toggle_vagrant_nic() finished' -t 'gce-2024-04-09';
}

remove_vagrant_nic() {
    /usr/bin/logger 'remove_vagrant_nic()' -t 'gce-2024-04-09';
    echo -e "\e[1;32mremove_vagrant_nic()\e[0m";
    echo -e "\e[1;32mcheck if started by Vagrant\e[0m";

    if test -f "/etc/VAGRANT_ENV"; then
        /usr/bin/logger 'Remove Vagrant eth0' -t 'gce-2024-04-09';
...
__EOF__
    ...
    /usr/bin/logger 'remove_vagrant_nic() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mremove_vagrant_nic() finished\e[0m";
}

remove_vagrant_user() {
    /usr/bin/logger 'remove_vagrant_user()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'remove_vagrant_user() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mremove_vagrant_user() finished\e[0m";
}

configure_maxrows() {
    /usr/bin/logger 'configure_maxrows()' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'configure_maxrows() finished' -t 'gce-2024-04-09';
    echo -e "\e[1;32mconfigure_maxrows() finished\e[0m";
}

send_mail() {
    /usr/bin/logger 'send_mail()' -t 'gce-2024-04-09';
...
main() {
    ...
    /usr/bin/logger 'Vagrant Environment Check for file' -t 'gce-2024-04-09';
    echo -e "\e[1;32mcheck if started by Vagrant\e[0m";
    if test -f "/etc/VAGRANT_ENV"; then
        /usr/bin/logger 'Use .env file in HOME' -t 'gce-2024-04-09';
        echo -e "\e[1;32mUse .env file in home\e[0m";
        export ENV_DIR=$HOME;
    else
        /usr/bin/logger 'Use .env file SCRIPT_DIR' -t 'gce-2024-04-09';
    ...
    /usr/bin/logger 'Installation complete - Give it a few minutes to complete ingestion of feed data into Postgres/Redis, then reboot' -t 'gce-2024-04-09';
    echo -e;
