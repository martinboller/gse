...
prepare_source() {    
    ...
    wget -O openvas.tar.gz https://github.com/greenbone/openvas-scanner/archive/refs/tags/v22.6.2.tar.gz > /dev/null 2>&1;
    ...
    mv /opt/gvm/src/greenbone/openvas-scanner-22.6.2 /opt/gvm/src/greenbone/openvas > /dev/null 2>&1;
...
[Service]
ExecStart=/opt/gvm/gvmpy/bin/greenbone-feed-sync --type all --user gvm --group gvm --gvmd-lock-file /var/run/gvmd/feed-update.lock --openvas-lock-file /var/run/gvmd/feed-update.lock
TimeoutSec=900
