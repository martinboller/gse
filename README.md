...
Name | URL | Version
---|---|---
gvm-libs | https://github.com/greenbone/gvm-libs/ | 22.39.0
...
GVM Daemon | https://github.com/greenbone/gvmd/ | 26.20.0
GSA Daemon | https://github.com/greenbone/gsad/ | 24.17.0
GSA | https://github.com/greenbone/gsa/ | 26.15.0
openvas-smb | https://github.com/greenbone/openvas-smb | 22.5.10
python-gvm | https://github.com/greenbone/python-gvm/ | 26.11.1
gvm-tools | https://github.com/greenbone/gvm-tools/ | 25.4.9
...
[API Reference for Greenbone GMP 22.7](https://docs.greenbone.net/API/GMP/gmp-22.7.html)
...
## 2025-02-20 - updates to
- gvm-libs, gvmd, gsad
- See table for all updates.
...
## 2025-02-08 - GCE updated from 22.04 to 24.10
- Openvas-scanner, openvas-smb, and gsad.
- See table for latest versions.
